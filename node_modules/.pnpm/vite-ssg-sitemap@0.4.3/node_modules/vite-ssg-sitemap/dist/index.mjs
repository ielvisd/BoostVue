import require$$0$1, { writeFileSync } from 'fs';
import require$$0 from 'stream';
import require$$2 from 'readline';
import require$$3 from 'url';
import require$$0$2, { parse as parse$4, join, isAbsolute, resolve } from 'path';
...
function getRoutes(options) {
  ...
  return [
    ...
    ...options.dynamicRoutes.map((route) => slash(join("/", join(parse$4(route).dir, parse$4(route).name))))
