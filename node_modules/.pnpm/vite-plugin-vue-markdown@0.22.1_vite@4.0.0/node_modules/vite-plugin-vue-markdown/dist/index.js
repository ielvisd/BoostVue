...
function createMarkdown(options) {
  ...
  if (options.frontmatter || options.excerpt) {
    markdown.use(import_plugin_frontmatter.frontmatterPlugin, {
...
function resolveOptions(userOptions) {
  ...
  const options = userOptions.frontmatterPreprocess ? { ...defaultOptions, ...userOptions } : {
    ...defaultOptions,
    ...userOptions,
