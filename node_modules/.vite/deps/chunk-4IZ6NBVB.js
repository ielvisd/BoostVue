...
var EMPTY_OBJ = import_process.default.env.NODE_ENV !== "production" ? Object.freeze({}) : {};
var EMPTY_ARR = import_process.default.env.NODE_ENV !== "production" ? Object.freeze([]) : [];
var NOOP = () => {
};
var NO = () => false;
var onRE = /^on[^a-z]/;
...
var EffectScope = class {
  ...
  run(fn) {
    ...
    } else if (import_process.default.env.NODE_ENV !== "production") {
...
var activeEffect;
var ITERATE_KEY = Symbol(import_process.default.env.NODE_ENV !== "production" ? "iterate" : "");
var MAP_KEY_ITERATE_KEY = Symbol(import_process.default.env.NODE_ENV !== "production" ? "Map key iterate" : "");
...
function track(target, type, key) {
  if (shouldTrack && activeEffect) {
    ...
    const eventInfo = import_process.default.env.NODE_ENV !== "production" ? { effect: activeEffect, target, type, key } : void 0;
...
function trackEffects(dep, debuggerEventExtraInfo) {
  ...
  if (shouldTrack2) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && activeEffect.onTrack) {
...
function trigger(target, type, key, newValue, oldValue, oldTarget) {
  ...
  const eventInfo = import_process.default.env.NODE_ENV !== "production" ? { target, type, key, newValue, oldValue, oldTarget } : void 0;
  if (deps.length === 1) {
    if (deps[0]) {
...
function triggerEffect(effect2, debuggerEventExtraInfo) {
  if (effect2 !== activeEffect || effect2.allowRecurse) {
    if (import_process.default.env.NODE_ENV !== "production" && effect2.onTrigger) {
...
function clear() {
  ...
  const oldTarget = import_process.default.env.NODE_ENV !== "production" ? isMap(target) ? new Map(target) : new Set(target) : void 0;
...
function triggerRef(ref2) {
  triggerRefValue(ref2, import_process.default.env.NODE_ENV !== "production" ? ref2.value : void 0);
}
function unref(ref2) {
...
function toRefs(object) {
  if (import_process.default.env.NODE_ENV !== "production" && !isProxy(object)) {
...
function computed(getterOrOptions, debugOptions, isSSR = false) {
  ...
  if (onlyGetter) {
    ...
    setter = import_process.default.env.NODE_ENV !== "production" ? () => {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && debugOptions && !isSSR) {
...
function handleError(err, instance, type, throwInDev = true) {
  ...
  if (instance) {
    ...
    const errorInfo = import_process.default.env.NODE_ENV !== "production" ? ErrorTypeStrings[type] : type;
    while (cur) {
...
function flushPreFlushCbs(seen, i = isFlushing ? flushIndex + 1 : 0) {
  ...
  for (; i < queue.length; i++) {
    const cb = queue[i];
    if (cb && cb.pre) {
      if (import_process.default.env.NODE_ENV !== "production" && checkRecursiveUpdates(seen, cb)) {
        continue;
      }
      queue.splice(i, 1);
      i--;
...
function flushPostFlushCbs(seen) {
  if (pendingPostFlushCbs.length) {
    ...
    for (postFlushIndex = 0; postFlushIndex < activePostFlushCbs.length; postFlushIndex++) {
      if (import_process.default.env.NODE_ENV !== "production" && checkRecursiveUpdates(seen, activePostFlushCbs[postFlushIndex])) {
        continue;
      }
...
function flushJobs(seen) {
  ...
  const check = import_process.default.env.NODE_ENV !== "production" ? (job) => checkRecursiveUpdates(seen, job) : NOOP;
  try {
    for (flushIndex = 0; flushIndex < queue.length; flushIndex++) {
      const job = queue[flushIndex];
      if (job && job.active !== false) {
        if (import_process.default.env.NODE_ENV !== "production" && check(job)) {
          continue;
        }
...
function emit$1(instance, event, ...rawArgs) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" || __VUE_PROD_DEVTOOLS__) {
...
function renderComponentRoot(instance) {
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && attrs === props) {
        markAttrsAccessed();
      }
      result = normalizeVNode(render3.length > 1 ? render3(props, import_process.default.env.NODE_ENV !== "production" ? {
        get attrs() {
          markAttrsAccessed();
          return attrs;
        },
  ...
  let root = result;
  let setRoot = void 0;
  if (import_process.default.env.NODE_ENV !== "production" && result.patchFlag > 0 && result.patchFlag & 2048) {
  ...
  if (fallthroughAttrs && inheritAttrs !== false) {
    ...
    if (keys.length) {
      ...
      } else if (import_process.default.env.NODE_ENV !== "production" && !accessedAttrs && root.type !== Comment) {
  ...
  if (vnode.dirs) {
    if (import_process.default.env.NODE_ENV !== "production" && !isElementRoot(root)) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && setRoot) {
    setRoot(root);
  } else {
    result = root;
  }
...
function shouldUpdateComponent(prevVNode, nextVNode, optimized) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && (prevChildren || nextChildren) && isHmrUpdating) {
    return true;
  }
...
function createSuspenseBoundary(vnode, parent, parentComponent, container, hiddenContainer, anchor, isSVG, slotScopeIds, optimized, rendererInternals, isHydrating = false) {
  if (import_process.default.env.NODE_ENV !== "production" && true && !hasWarned) {
    hasWarned = true;
...
function normalizeSuspenseSlot(s) {
  ...
  if (isArray(s)) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && !singleChild) {
...
function watchPostEffect(effect2, options) {
  return doWatch(effect2, null, import_process.default.env.NODE_ENV !== "production" ? Object.assign(Object.assign({}, options), { flush: "post" }) : { flush: "post" });
}
function watchSyncEffect(effect2, options) {
  return doWatch(effect2, null, import_process.default.env.NODE_ENV !== "production" ? Object.assign(Object.assign({}, options), { flush: "sync" }) : { flush: "sync" });
}
var INITIAL_WATCHER_VALUE = {};
function watch(source, cb, options) {
  if (import_process.default.env.NODE_ENV !== "production" && !isFunction(cb)) {
...
function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = EMPTY_OBJ) {
  if (import_process.default.env.NODE_ENV !== "production" && !cb) {
    if (immediate !== void 0) {
  ...
  if (isRef(source)) {
    ...
    getter = () => source.map((s) => {
      if (isRef(s)) {
        ...
        import_process.default.env.NODE_ENV !== "production" && warnInvalidSource(s);
      }
    });
    ...
    getter = NOOP;
    import_process.default.env.NODE_ENV !== "production" && warnInvalidSource(source);
  }
  if (cb && deep) {
    ...
    return () => {
      ...
      if (children.length > 1) {
        ...
        for (const c of children) {
          if (c.type !== Comment) {
            if (import_process.default.env.NODE_ENV !== "production" && hasFound) {
      ...
      const { mode } = rawProps;
      if (import_process.default.env.NODE_ENV !== "production" && mode && mode !== "in-out" && mode !== "out-in" && mode !== "default") {
...
function defineAsyncComponent(source) {
  ...
  const load = () => {
    ...
    return pendingRequest || (thisRequest = pendingRequest = loader().catch((err) => {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && !comp) {
        warn2(`Async component loader resolved to undefined. If you are using retry(), make sure to return its return value.`);
      }
      if (comp && (comp.__esModule || comp[Symbol.toStringTag] === "Module")) {
        comp = comp.default;
      }
      if (import_process.default.env.NODE_ENV !== "production" && comp && !isObject(comp) && !isFunction(comp)) {
...
function withDirectives(vnode, directives) {
  ...
  if (internalInstance === null) {
    import_process.default.env.NODE_ENV !== "production" && warn2(`withDirectives can only be used inside render functions.`);
    return vnode;
  }
...
function resolveAsset(type, name, warnMissing = true, maybeSelfReference = false) {
  ...
  if (instance) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && warnMissing && !res) {
...
function renderList(source, renderItem, cache, index) {
  ...
  if (isArray(source) || isString(source)) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && !Number.isInteger(source)) {
...
function renderSlot(slots, name, props = {}, fallback, noSlotted) {
  ...
  let slot = slots[name];
  if (import_process.default.env.NODE_ENV !== "production" && slot && slot.length > 1) {
...
function toHandlers(obj, preserveCaseIfNecessary) {
  const ret = {};
  if (import_process.default.env.NODE_ENV !== "production" && !isObject(obj)) {
...
var publicPropertiesMap = extend(/* @__PURE__ */ Object.create(null), {
  ...
  $el: (i) => i.vnode.el,
  $data: (i) => i.data,
  $props: (i) => import_process.default.env.NODE_ENV !== "production" ? shallowReadonly(i.props) : i.props,
  $attrs: (i) => import_process.default.env.NODE_ENV !== "production" ? shallowReadonly(i.attrs) : i.attrs,
  $slots: (i) => import_process.default.env.NODE_ENV !== "production" ? shallowReadonly(i.slots) : i.slots,
  $refs: (i) => import_process.default.env.NODE_ENV !== "production" ? shallowReadonly(i.refs) : i.refs,
...
var PublicInstanceProxyHandlers = {
  get({ _: instance }, key) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && key === "__isVue") {
      return true;
    }
    let normalizedProps;
    if (key[0] !== "$") {
    ...
    if (publicGetter) {
      if (key === "$attrs") {
        ...
        import_process.default.env.NODE_ENV !== "production" && markAttrsAccessed();
      }
    ...
    } else if (import_process.default.env.NODE_ENV !== "production" && currentRenderingInstance && (!isString(key) || key.indexOf("__v") !== 0)) {
  ...
  set({ _: instance }, key, value) {
    ...
    if (hasSetupBinding(setupState, key)) {
      ...
      return true;
    } else if (import_process.default.env.NODE_ENV !== "production" && setupState.__isScriptSetup && hasOwn(setupState, key)) {
      ...
      import_process.default.env.NODE_ENV !== "production" && warn2(`Attempting to mutate prop "${key}". Props are readonly.`);
      return false;
    }
    if (key[0] === "$" && key.slice(1) in instance) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`Attempting to mutate public property "${key}". Properties starting with $ are reserved and readonly.`);
      return false;
    } else {
      if (import_process.default.env.NODE_ENV !== "production" && key in instance.appContext.config.globalProperties) {
...
if (import_process.default.env.NODE_ENV !== "production" && true) {
...
var RuntimeCompiledPublicInstanceProxyHandlers = extend({}, PublicInstanceProxyHandlers, {
  ...
  has(_, key) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && !has2 && PublicInstanceProxyHandlers.has(_, key)) {
...
function applyOptions(instance) {
  ...
  const checkDuplicateProperties = import_process.default.env.NODE_ENV !== "production" ? createDuplicateChecker() : null;
  if (import_process.default.env.NODE_ENV !== "production") {
  ...
  if (dataOptions) {
    if (import_process.default.env.NODE_ENV !== "production" && !isFunction(dataOptions)) {
      warn2(`The data option must be a function. Plain object usage is no longer supported.`);
    }
    const data = dataOptions.call(publicThis, publicThis);
    if (import_process.default.env.NODE_ENV !== "production" && isPromise(data)) {
    ...
    if (!isObject(data)) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`data() should return an object.`);
    } else {
  ...
  if (computedOptions) {
    for (const key in computedOptions) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && get2 === NOOP) {
        warn2(`Computed property "${key}" has no getter.`);
      }
      const set2 = !isFunction(opt) && isFunction(opt.set) ? opt.set.bind(publicThis) : import_process.default.env.NODE_ENV !== "production" ? () => {
...
function mergeOptions(to, from, strats, asMixin = false) {
  ...
  for (const key in from) {
    if (asMixin && key === "expose") {
      import_process.default.env.NODE_ENV !== "production" && warn2(`"expose" option is ignored when declared in mixins or extends. It should only be declared in the base component itself.`);
    } else {
...
function updateProps(instance, rawProps, rawPrevProps, optimized) {
  ...
  if (!(import_process.default.env.NODE_ENV !== "production" && isInHmrContext(instance)) && (optimized || patchFlag > 0) && !(patchFlag & 16)) {
    if (patchFlag & 8) {
...
function normalizePropsOptions(comp, appContext, asMixin = false) {
  ...
  if (isArray(raw)) {
    for (let i = 0; i < raw.length; i++) {
      if (import_process.default.env.NODE_ENV !== "production" && !isString(raw[i])) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && !isObject(raw)) {
...
var normalizeSlot = (key, rawSlot, ctx) => {
  ...
  const normalized = withCtx((...args) => {
    if (import_process.default.env.NODE_ENV !== "production" && currentInstance) {
...
var normalizeVNodeSlots = (instance, children) => {
  if (import_process.default.env.NODE_ENV !== "production" && !isKeepAlive(instance.vnode) && true) {
...
var updateSlots = (instance, children, optimized) => {
  ...
  if (vnode.shapeFlag & 32) {
    const type = children._;
    if (type) {
      if (import_process.default.env.NODE_ENV !== "production" && isHmrUpdating) {
...
function createAppAPI(render2, hydrate2) {
  return function createApp2(rootComponent, rootProps = null) {
    ...
    if (rootProps != null && !isObject(rootProps)) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`root props passed to app.mount() must be an object.`);
      rootProps = null;
    }
    ...
    const app = context.app = {
      ...
      use(plugin, ...options) {
        if (installedPlugins.has(plugin)) {
          import_process.default.env.NODE_ENV !== "production" && warn2(`Plugin has already been applied to target app.`);
      ...
      component(name, component) {
        ...
        if (import_process.default.env.NODE_ENV !== "production" && context.components[name]) {
      ...
      directive(name, directive) {
        ...
        if (import_process.default.env.NODE_ENV !== "production" && context.directives[name]) {
      ...
      mount(rootContainer, isHydrate, isSVG) {
        if (!isMounted) {
          if (import_process.default.env.NODE_ENV !== "production" && rootContainer.__vue_app__) {
...
If you want to remount the same app, move your app creation logic into a factory function and create fresh app instances for each mount - e.g. \`const createMyApp = () => createApp(App)\``);
      ...
      provide(key, value) {
        if (import_process.default.env.NODE_ENV !== "production" && key in context.provides) {
...
function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && !owner) {
...
function createHydrationFunctions(rendererInternals) {
  ...
  const hydrate2 = (vnode, container) => {
    if (!container.hasChildNodes()) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`Attempting to hydrate existing markup but container is empty. Performing full mount instead.`);
      ...
      case Text:
        if (domType !== 3) {
          ...
          if (node.data !== vnode.children) {
            hasMismatch = true;
            import_process.default.env.NODE_ENV !== "production" && warn2(`Hydration text mismatch:
...
- Server: ${JSON.stringify(vnode.children)}`);
  ...
  const hydrateElement = (el, vnode, parentComponent, parentSuspense, slotScopeIds, optimized) => {
    ...
    if (import_process.default.env.NODE_ENV !== "production" || forcePatchValue || patchFlag !== -1) {
      if (dirs) {
      ...
      if (shapeFlag & 16 && !(props && (props.innerHTML || props.textContent))) {
        ...
        while (next) {
          hasMismatch = true;
          if (import_process.default.env.NODE_ENV !== "production" && !hasWarned2) {
        ...
        if (el.textContent !== vnode.children) {
          hasMismatch = true;
          import_process.default.env.NODE_ENV !== "production" && warn2(`Hydration text content mismatch in <${vnode.type}>:
...
- Server: ${vnode.children}`);
  ...
  const handleMismatch = (node, vnode, parentComponent, parentSuspense, slotScopeIds, isFragment) => {
    hasMismatch = true;
    import_process.default.env.NODE_ENV !== "production" && warn2(`Hydration node mismatch:
...
function initFeatureFlags() {
  ...
  if (typeof __VUE_OPTIONS_API__ !== "boolean") {
    import_process.default.env.NODE_ENV !== "production" && needWarn.push(`__VUE_OPTIONS_API__`);
    getGlobalThis().__VUE_OPTIONS_API__ = true;
  }
  if (typeof __VUE_PROD_DEVTOOLS__ !== "boolean") {
    import_process.default.env.NODE_ENV !== "production" && needWarn.push(`__VUE_PROD_DEVTOOLS__`);
    getGlobalThis().__VUE_PROD_DEVTOOLS__ = false;
  }
  if (import_process.default.env.NODE_ENV !== "production" && needWarn.length) {
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const patch = (n1, n2, container, anchor = null, parentComponent = null, parentSuspense = null, isSVG = false, slotScopeIds = null, optimized = import_process.default.env.NODE_ENV !== "production" && isHmrUpdating ? false : !!n2.dynamicChildren) => {
    if (n1 === n2) {
      return;
    }
  ...
  const setScopeId = (el, vnode, scopeId, slotScopeIds, parentComponent) => {
    ...
    if (parentComponent) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && subTree.patchFlag > 0 && subTree.patchFlag & 2048) {
  ...
  const patchElement = (n1, n2, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) => {
    ...
    if (dynamicChildren) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && parentComponent && parentComponent.type.__hmrId) {
  ...
  const processFragment = (n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) => {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && (isHmrUpdating || patchFlag & 2048)) {
      patchFlag = 0;
      optimized = false;
      dynamicChildren = null;
    }
  ...
  const mountComponent = (initialVNode, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && instance.type.__hmrId) {
    ...
    if (i > e1) {
      ...
      for (i = s2; i <= e2; i++) {
        ...
        if (nextChild.key != null) {
          if (import_process.default.env.NODE_ENV !== "production" && keyToNewIndexMap.has(nextChild.key)) {
  ...
  const remove2 = (vnode) => {
    ...
    if (type === Fragment) {
      if (import_process.default.env.NODE_ENV !== "production" && vnode.patchFlag > 0 && vnode.patchFlag & 2048 && transition && !transition.persisted) {
...
function traverseStaticChildren(n1, n2, shallow = false) {
  ...
  if (isArray(ch1) && isArray(ch2)) {
    for (let i = 0; i < ch1.length; i++) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && c2.type === Comment && !c2.el) {
        c2.el = c1.el;
      }
    }
  }
...
var resolveTarget = (props, select) => {
  ...
  if (isString(targetSelector)) {
    if (!select) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`Current renderer does not support string target for Teleports. (missing querySelector renderer option)`);
      return null;
    } else {
      const target = select(targetSelector);
      if (!target) {
        import_process.default.env.NODE_ENV !== "production" && warn2(`Failed to locate Teleport target with selector "${targetSelector}". Note the target element must exist before the component is mounted - i.e. the target cannot be rendered by the component itself, and ideally should be outside of the entire Vue component tree.`);
      }
      return target;
    }
  } else {
    if (import_process.default.env.NODE_ENV !== "production" && !targetSelector && !isTeleportDisabled(props)) {
...
var TeleportImpl = {
  ...
  process(n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized, internals) {
    ...
    if (n1 == null) {
      const placeholder = n2.el = import_process.default.env.NODE_ENV !== "production" ? createComment("teleport start") : createText("");
      const mainAnchor = n2.anchor = import_process.default.env.NODE_ENV !== "production" ? createComment("teleport end") : createText("");
      ...
      } else if (import_process.default.env.NODE_ENV !== "production" && !disabled) {
...
var Fragment = Symbol(import_process.default.env.NODE_ENV !== "production" ? "Fragment" : void 0);
var Text = Symbol(import_process.default.env.NODE_ENV !== "production" ? "Text" : void 0);
var Comment = Symbol(import_process.default.env.NODE_ENV !== "production" ? "Comment" : void 0);
var Static = Symbol(import_process.default.env.NODE_ENV !== "production" ? "Static" : void 0);
var blockStack = [];
...
function isSameVNodeType(n1, n2) {
  if (import_process.default.env.NODE_ENV !== "production" && n2.shapeFlag & 6 && hmrDirtyComponents.has(n2.type)) {
    n1.shapeFlag &= ~256;
    n2.shapeFlag &= ~512;
    return false;
  }
...
function createBaseVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, shapeFlag = type === Fragment ? 0 : 1, isBlockNode = false, needFullChildrenNormalization = false) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && vnode.key !== vnode.key) {
...
var createVNode = import_process.default.env.NODE_ENV !== "production" ? createVNodeWithArgsTransform : _createVNode;
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  if (!type || type === NULL_DYNAMIC_COMPONENT) {
    if (import_process.default.env.NODE_ENV !== "production" && !type) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && shapeFlag & 4 && isProxy(type)) {
    type = toRaw(type);
...
function cloneVNode(vnode, extraProps, mergeRef = false) {
  ...
  const cloned = {
    ...
    children: import_process.default.env.NODE_ENV !== "production" && patchFlag === -1 && isArray(children) ? children.map(deepCloneVNode) : children,
    target: vnode.target,
...
function setupStatefulComponent(instance, isSSR) {
  ...
  if (setup) {
    ...
    setCurrentInstance(instance);
    pauseTracking();
    const setupResult = callWithErrorHandling(setup, instance, 0, [import_process.default.env.NODE_ENV !== "production" ? shallowReadonly(instance.props) : instance.props, setupContext]);
    resetTracking();
    unsetCurrentInstance();
    if (isPromise(setupResult)) {
      ...
      if (isSSR) {
        ...
        if (import_process.default.env.NODE_ENV !== "production" && !instance.suspense) {
...
function handleSetupResult(instance, setupResult, isSSR) {
  if (isFunction(setupResult)) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && isVNode(setupResult)) {
  ...
  } else if (import_process.default.env.NODE_ENV !== "production" && setupResult !== void 0) {
...
function finishComponentSetup(instance, isSSR, skipOptions) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && !Component.render && instance.render === NOOP && !isSSR) {
...
function createAttrsProxy(instance) {
  return new Proxy(instance.attrs, import_process.default.env.NODE_ENV !== "production" ? {
    get(target, key) {
      markAttrsAccessed();
...
function createSetupContext(instance) {
  const expose = (exposed) => {
    if (import_process.default.env.NODE_ENV !== "production" && instance.exposed) {
...
function getContext() {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && !i) {
...
function withAsyncContext(getAwaitable) {
  ...
  if (import_process.default.env.NODE_ENV !== "production" && !ctx) {
...
var ssrContextKey = Symbol(import_process.default.env.NODE_ENV !== "production" ? `ssrContext` : ``);
var useSSRContext = () => {
  {
    const ctx = inject(ssrContextKey);
    if (!ctx) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`Server rendering context not provided. Make sure to only call useSSRContext() conditionally in the server build.`);
    }
    return ctx;
  }
};
...
function initCustomFormatter() {
  if (!(import_process.default.env.NODE_ENV !== "production") || typeof window === "undefined") {
    return;
  }
...
function patchDOMProp(el, key, value, prevChildren, parentComponent, parentSuspense, unmountChildren) {
  ...
  try {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && !needRemove) {
...
var VueElement = class extends BaseClass {
  constructor(_def, _props = {}, hydrate2) {
    ...
    if (this.shadowRoot && hydrate2) {
      ...
      if (import_process.default.env.NODE_ENV !== "production" && this.shadowRoot) {
...
function useCssModule(name = "$style") {
  {
    const instance = getCurrentInstance();
    if (!instance) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`useCssModule must be called inside setup()`);
      return EMPTY_OBJ;
    }
    const modules = instance.type.__cssModules;
    if (!modules) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`Current instance does not have CSS modules injected.`);
      return EMPTY_OBJ;
    }
    const mod = modules[name];
    if (!mod) {
      import_process.default.env.NODE_ENV !== "production" && warn2(`Current instance does not have CSS module named "${name}".`);
      return EMPTY_OBJ;
    }
    return mod;
  }
...
function useCssVars(getter) {
  const instance = getCurrentInstance();
  if (!instance) {
    import_process.default.env.NODE_ENV !== "production" && warn2(`useCssVars is called without current active component instance.`);
    return;
  }
...
function setSelected(el, value) {
  ...
  if (isMultiple && !isArray(value) && !isSet(value)) {
    import_process.default.env.NODE_ENV !== "production" && warn2(`<select multiple v-model> expects an Array or Set value for its binding, but got ${Object.prototype.toString.call(value).slice(8, -1)}.`);
    return;
  }
...
function normalizeContainer(container) {
  if (isString(container)) {
    ...
    if (import_process.default.env.NODE_ENV !== "production" && !res) {
      warn2(`Failed to mount app: mount target selector "${container}" returned null.`);
    }
    return res;
  }
  if (import_process.default.env.NODE_ENV !== "production" && window.ShadowRoot && container instanceof window.ShadowRoot && container.mode === "closed") {
...
//# sourceMappingURL=chunk-4IZ6NBVB.js.map
